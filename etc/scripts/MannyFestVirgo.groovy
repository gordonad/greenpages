...
//            StandardBundleManifest sbm = new StandardBundleManifest(new SimpleParserLogger(), manifestContents.getMainAttributes())
//            println "BUNDLE DESCRIPTION: ${sbm.bundleDescription}"
//            println "BUNDLE Manifest Version: ${sbm.bundleManifestVersion}"
//            println "BUNDLE Version: ${sbm.bundleVersion?.toString()}"
//            println "BUNDLE NAME: ${sbm.bundleName}"
//            println "BUNDLE Scope: ${sbm.moduleScope}"
//            println "BUNDLE Type: ${sbm.moduleType}"
//
//
//            ExportPackage exportPackage = sbm.exportPackage
//            println "ExportPackage:  $exportPackage"
////            println "BUNDLE: $sbm"
////            println "BUNDLE NAME: ${sbm.bundleSymbolicName}"
//*/
